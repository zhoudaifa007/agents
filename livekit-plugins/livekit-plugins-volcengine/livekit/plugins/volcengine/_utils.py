...
def _to_volcengine_url(opts: dict, base_url: str, *, websocket: bool) -> str:
    """Convert options to a Volcengine API URL with query parameters."""
    ...
    # Switch between ws and http based on websocket flag
    ...
    # Volcengine API does not typically use query parameters in WebSocket URLs
    # If needed, append query parameters here
    return base_url